...
import { folderNameFilter } from '../utils/filters.js';
 ...
 */
export function hasCliArgument(fieldName, generator) {
...
export const appFields = {
  ...
  contentRepoLocation: {
    ...
    default() {
      ...
      return path.join(parentDir, 'vagov-content');
    },
  },
  slackGroup: {
    type: 'input',
 ...
 */
export function getFieldDefinitions(type = 'app') {
  switch (type) {
    case 'app':
      return appFields;
    case 'form':
 ...
 */
export function getContextualFieldDefinitions(isForm) {
 ...
 */
export function getRequiredFields(isForm) {
 ...
 */
export function getNonInteractiveRequiredFields(options) {
 ...
 * @returns {Array} - Array of required field names
 */
export function getLegacyRequiredFields(options) {
 ...
 */
export function generatePrompts(generator, fieldDefinitions, fieldNames = null) {
