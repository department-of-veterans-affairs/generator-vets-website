 ...
 * Single source of truth for a  isForm: {
    type: 'confirm',
    ...
    when(_answers) {
      ...
      return process.argv.indexOf('--is-form') === -1;
    },
  },onfigurations
 */
...
const formFields = {
  ...
  ombExpiration: {
    type: 'input',
    message: 'Enter the OMB expiration date (ex. 8/31/2023):',
    default() {
