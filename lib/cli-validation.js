 ...
 * @returns {boolean|string} - true if valid, error message if invalid
 */
export function validateOmbNumber(ombNumber) {
 ...
 * @returns {boolean|string} - true if valid, error message if invalid
 */
export function validateRespondentBurden(respondentBurden) {
 ...
 * @returns {boolean|string} - true if valid, error message if invalid
 */
export function validateTemplateType(templateType) {
 ...
 */
export function validateAllCliArguments(options) {
  const errors = [];
...
export function isNonInteractiveMode(options) {
  ...
  const cliFields = [
    ...
    'rootUrl',
    'isForm',
    'contentLoc', // Legacy backward compatibility
    'contentRepoLocation', // Primary field name
    'slackGroup',
    'formNumber',
    'trackingPrefix',
    'respondentBurden',
 ...
 */
export function validateRequiredCliArguments(options) {
...
export { getNonInteractiveRequiredFields };
