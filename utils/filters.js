 ...
 */
export function folderNameFilter(folder) {
 ...
 */
export function rootUrlFilter(rootUrl) {
 ...
 */
export function fieldNameToCliArg(fieldName) {
 ...
 */
export function generateFormIdConst(formNumber) {
 ...
 */
export function generateTrackingPrefix(formNumber) {
